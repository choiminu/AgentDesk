...
요구 사항: macOS, [Orca](https://github.com/stablyai/orca) 1.4 이상(`orca --version`), Node.js 18 이상.
...
설치 후 권장: **오피스** 탭에서 **정확 감지**를 켜세요. Claude Code 훅을 등록해([동작 원리](#동작-원리) 참고) 상태를 추정하지 않고 이벤트로 받습니다.
